...
#define NIL_PARAMETER_ERROR(parameter) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorCodeBadParameters description:[NSString stringWithFormat:@"%@ parameter cannot be null", parameter]]
...
#define NIL_OPTION_ERROR(parameter, field) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorCodeMissingParameters description:[NSString stringWithFormat:@"\"%@\" field in %@ is required", field, parameter]]
...
#define BAD_OPTION_TYPE_ERROR(parameter, field) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorCodeBadParameters description:[NSString stringWithFormat:@"invalid type for field \"%@\" in %@", field, parameter]]
