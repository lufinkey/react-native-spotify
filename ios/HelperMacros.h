...
#define NIL_PARAMETER_ERROR(parameter) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorBadParameters description:[NSString stringWithFormat:@"%@ parameter cannot be null", parameter]]
...
#define NIL_OPTION_ERROR(parameter, field) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorMissingParameters description:[NSString stringWithFormat:@"\"%@\" field in %@ is required", field, parameter]]
...
#define BAD_OPTION_TYPE_ERROR(parameter, field) \
	[RCTSpotify errorWithCode:RCTSpotifyErrorBadParameters description:[NSString stringWithFormat:@"invalid type for field \"%@\" in %@", field, parameter]]
