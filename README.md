...
**NOTE:** This repo is using the deprecated Spotify streaming SDKs. They could stop working at any time! I'm only doing bug fixes on this repo and I don't really have a whole lot of time to update it. [react-native-spotift-remote](https://github.com/cjam/react-native-spotify-remote) is being worked on by someone else to use the updated SDK.
